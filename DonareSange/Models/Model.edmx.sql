...
-- --------------------------------------------------
-- Date Created: 06/01/2018 19:31:58
-- Generated from EDMX file: C:\Users\HP PC\Documents\AutomaticSolution Software\GitHub\DonareSange\DonareSange\Models\Model.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_BloodRequest_Centre]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[BloodRequest] DROP CONSTRAINT [FK_BloodRequest_Centre];
GO
IF OBJECT_ID(N'[dbo].[FK_BloodRequest_Clinic]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[BloodRequest] DROP CONSTRAINT [FK_BloodRequest_Clinic];
GO
IF OBJECT_ID(N'[dbo].[FK_Centre_Address]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Centre] DROP CONSTRAINT [FK_Centre_Address];
GO
IF OBJECT_ID(N'[dbo].[FK_Clinic_Address]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Clinic] DROP CONSTRAINT [FK_Clinic_Address];
GO
...
IF OBJECT_ID(N'[dbo].[FK_Donation_AspNetUsers]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Donation] DROP CONSTRAINT [FK_Donation_AspNetUsers];
GO
IF OBJECT_ID(N'[dbo].[FK_Donation_Centre]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Donation] DROP CONSTRAINT [FK_Donation_Centre];
GO
...
IF OBJECT_ID(N'[dbo].[FK_PersonalDetailsDoctor_AspNetUsers]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[PersonalDetailsDoctor] DROP CONSTRAINT [FK_PersonalDetailsDoctor_AspNetUsers];
GO
IF OBJECT_ID(N'[dbo].[FK_PersonalDetailsDoctor_Clinic]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[PersonalDetailsDoctor] DROP CONSTRAINT [FK_PersonalDetailsDoctor_Clinic];
GO
